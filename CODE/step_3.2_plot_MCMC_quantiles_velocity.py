...
X_train = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/X_train_DK_demented_adults.pkl",'rb')).to_numpy()
Y_train = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/Y_train_DK_demented_adults.pkl",'rb'))
Z_train = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/trbefile_DK_demented_adults.pkl",'rb')).to_numpy()
X_test = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/X_test_DK_demented_adults.pkl",'rb')).to_numpy()
Y_test = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/Y_test_DK_demented_adults.pkl",'rb'))
Z_test = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/tebefile_DK_demented_adults.pkl",'rb')).to_numpy()
#
# In[4]:
...
def plot_MAP_quantiles(feature ="L_bankssts", l='SHASHo',selected_sex='female', atlas ='SC'):
    ...
    try:
        model_path = f"{l}_estimate_scaled_fixed_{atlas}_demented_adults_ADNI/batch_{f_idx+1}/Models/NM_0_0_estimate.pkl"
        #model_path =  f"Transfer_{l}_{atlas}_demented_adults/NM_0_0_transfer{f_idx}.pkl"
        #model_path = f"{l}_estimate_scaled_fixed_{atlas}_retrain/batch_{f_idx+1}/Models/NM_0_0_estimate.pkl"
        #model_path = f"{l}_retrain_{atlas}_adults/batch_{f_idx+1}/Models/NM_0_0_fit.pkl"
...
Z_train = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/trbefile_SC_demented_adults.pkl",'rb')).to_numpy()
X_test = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/X_test_SC_demented_adults.pkl",'rb')).to_numpy()
Y_test = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/Y_test_SC_demented_adults.pkl",'rb'))
Z_test = pickle.load(open("/project_cephfs/3022017.06/projects/lifespan_hbr/johbay/Velocity/DATA_NM/tebefile_SC_demented_adults.pkl",'rb')).to_numpy()
