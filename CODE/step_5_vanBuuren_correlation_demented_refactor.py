...
for idp_nr, measure in enumerate(measures):
    ...
    clean_df, data, data_all, data_demented, OAS2_0157 = process_data(idp_nr, measure, model_type = "SHASHb_1", atlas = "DK", full_dataset=True)
    make_velocity_plots(idp_nr=idp_nr, measure=measure,data=clean_df, selected_sex='male', model_type='SHASHb_1', atlas="DK",re_estimate = True, full_dataset=True)
